...
- [Pre-Registered OOS and Regime-Separated Validation Plan](pre_registered_oos_regime_validation_plan.md): Locks future outcome-blind candidate selection, frozen-runner comparability, strict chronological sensitivity boundaries, market-only regime definitions, decision classifications, stop conditions, and candidate-addendum requirements; OOS and regime-separated validation remain incomplete.
