...
- [x] The general outcome-blind OOS and regime-separated framework is pre-registered in `docs/pre_registered_oos_regime_validation_plan.md`; this is planning evidence only, and a candidate-specific locked addendum plus new fully accepted non-overlapping data remain required.
